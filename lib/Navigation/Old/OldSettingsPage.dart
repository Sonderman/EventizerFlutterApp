...
class OldSettingsPage extends StatefulWidget {
  @override
  _OldSettingsPageState createState() => _OldSettingsPageState();
}
                    ...
                    child: MaterialButton(
                      onPressed: () async {
                        if (controllerMevcut.text ==
                          ...
                          triggerToast = true;
                          userWorker.userModel
                              .setUserEmail(controllerYeni.text);
  ...
  Widget updateMyPersonalInfoDialog(UserService userWorker) {
    ...
    if (controllerAd == null) {
      ...
      controllerTelNo = TextEditingController(
          text: userWorker.userModel.getUserTelNo().toString());
    }
