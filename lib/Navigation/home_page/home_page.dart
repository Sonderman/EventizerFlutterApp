            ...
            children: <Widget>[
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: "Bu uygulama\n",
                        style: TextStyle(color: Colors.black, fontSize: responsive.widthSize(4)),
                      ),
                      TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () async {
                            const url = 'https://www.linkedin.com/in/alihaydar-ayar-b45a4315b/';
              ...
              MaterialButton(
                ...
                child: const Row(
                  ...
                  children: <Widget>[Icon(Icons.play_arrow), Text("Play Store")],
                ),
              ),
              const Spacer(),
              GestureDetector(
                ...
                child: const Row(
                  mainAxisSize: MainAxisSize.min,
                  children: <Widget>[
                    Padding(padding: EdgeInsets.all(8.0), child: Icon(Icons.feedback, size: 40)),
                    Text("Sorun Bildir"),
                  ],
                ),
              ),
